...
import com.pointlion.sys.mvc.common.model.SysUserInfo;
...
public class HomeController extends BaseController {
    ...
    public void index(){
    	...
    	info.setBirthday(getParaToDate());
    	info.setAddress("贵州");
    	info.setBlood("A");
    	info.setCulture("本科");
    	info.setDescription("是一个好人");
    	info.setFinishSchoolDate(getParaToDate());
    	info.setFolk("汉族");
    	info.setGovernment("团员");
    	info.setHeight("167");
    	info.setHomepage("可爱");
    	info.setHouseholder("张三");
    	info.setId(UuidUtil.getUUID());
    	info.setMarriage("未婚");
    	info.setMsn("123");
    	info.setNativityAddress("毕节");
    	info.setPostCode("25525");
    	info.setQq("31245678");
    	info.setSpeciality("打篮球");
    	info.setUserId(user.getId());
    	SysUserInfo.dao.save();*/
